...
from PySide6.QtCore import Slot #type: ignore # noqa
from PySide6.QtWidgets import (QApplication, QGridLayout, QMainWindow, QPushButton, QWidget) # noqa #type: ignore
...
# define decorator with empty arguments
@Slot()
